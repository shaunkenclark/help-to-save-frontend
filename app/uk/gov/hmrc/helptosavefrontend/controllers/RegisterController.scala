...
object RegisterController {
  ...
  object JSONValidationFeature {
    ...
    val logClassificationRules = Map[LogClassificationRule, String](
      ...
      LogClassificationRule("/forename", "pattern") ->                     "For NINO: %s. This forename contained an unrecognised char sequence",
      ...
      LogClassificationRule("/surname", "pattern") ->                      "For NINO: %s. This surname contained an unrecognised char sequence",
      ...
      LogClassificationRule("/dateOfBirth", "pattern") ->                  "For NINO: %s. This date of birth contained an unrecognised char sequence",
      ...
      LogClassificationRule("/contactDetails/countryCode", "pattern") ->   "For NINO: %s. This country code contained an unrecognised char sequence",
      ...
      LogClassificationRule("/contactDetails/communicationPreference", "pattern") ->     "For NINO: %s. This communications preference contained an unrecognised char sequence",
      ...
      LogClassificationRule("/registrationChannel", "pattern") ->          "For NINO: %s. This registration channel contained an unrecognised char sequence",
      ...
      LogClassificationRule("/nino", "pattern") ->                         "For NINO: %s. This NINO contained an unrecognised char sequence",
